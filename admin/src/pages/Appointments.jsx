          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full md:w-auto">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <select
                ...
                className="rounded-lg border border-gray-200 px-4 py-2 focus:ring-2 focus:ring-blue-500 w-full"
              >
                  ...
                  >
                    ...
                    <td className="px-4 sm:px-6 py-4">
                      <div className="flex items-center">
                        <Home className="w-5 h-5 text-gray-400 mr-2 flex-shrink-0" />
                      ...
                      {editingMeetingLink === appointment._id ? (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="p-1 bg-gray-500 text-white rounded hover:bg-gray-600 flex-shrink-0"
                          >
                            <X className="w-4 h-4" />
                          </button>
                        </div>
                      ...
                      {appointment.status === "pending" && (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="p-1 bg-red-500 text-white rounded hover:bg-red-600 flex-shrink-0"
                          >
                            <X className="w-4 h-4" />
                          </button>
                        </div>
