  ...
  return (
    ...
    >
      ...
      <div className="relative h-64">
        ...
        >
          <img
            src="/images/32px-Bookmark-solid.png" // Updated path
            alt="Bookmark"
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center py-3 border-y border-gray-100 dark:border-gray-700 mb-4">
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm text-gray-600 dark:text-gray-300">{property.beds} {property.beds > 1 ? 'Beds' : 'Bed'}</span>
          </div>
          <div className="flex items-center gap-1">
            <Bath className="w-4 h-4 text-primary-500" />
            <span className="text-sm text-gray-600 dark:text-gray-300">{property.baths} {property.baths > 1 ? 'Baths' : 'Bath'}</span>
          </div>
          <div className="flex items-center gap-1">
            <Maximize className="w-4 h-4 text-primary-500" />
            <span className="text-sm text-gray-600 dark:text-gray-300">{property.sqft} sqft</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 px-2 py-1 rounded-md flex items-center">
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-primary-600 font-semibold tracking-wide uppercase text-sm">Explore Properties</span>
