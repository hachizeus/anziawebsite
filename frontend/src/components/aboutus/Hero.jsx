      ...
      <div className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <motion.div
            ...
            animate={{
              background: [
                'linear-gradient(to bottom right, rgba(59, 130, 246, 1), rgba(37, 99, 235, 1), rgba(75, 75, 75, 0.8))',
                'linear-gradient(to bottom right, rgba(37, 99, 235, 1), rgba(75, 75, 75, 0.8), rgba(59, 130, 246, 1))',
                'linear-gradient(to bottom right, rgba(75, 75, 75, 0.8), rgba(59, 130, 246, 1), rgba(37, 99, 235, 1))'
              ]
            }}
          ...
          <div className="absolute inset-0 opacity-20">
            ...
            <motion.div 
              className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full bg-blue-400"
              animate={{ 
                x: [0, -40, 0, 40, 0],
                y: [0, 40, 0, -40, 0],
                scale: [1, 0.9, 1, 1.1, 1]
            ...
            <motion.div 
              className="absolute top-1/3 right-1/3 w-80 h-80 rounded-full bg-blue-200"
              animate={{ 
                x: [0, 50, 0, -50, 0],
                y: [0, -50, 0, 50, 0],
                scale: [1, 1.2, 1, 0.8, 1]
        ...
        >
          ...
          <p className="text-xl md:text-2xl leading-relaxed font-light">
            We're more than just an electronics supplier – we're your trusted partner in providing high-quality tools, equipment, and solutions for your professional and personal needs.
          </p>
