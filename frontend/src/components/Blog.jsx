...
import { Calendar, ArrowRight, Clock, Search, Tag, ExternalLink, ChevronRight, Loader } from '../utils/icons.jsx';
      ...
      <div className="relative overflow-hidden aspect-w-16 aspect-h-9">
          ...
          {isHovered && (
            ...
            >
              <button
                ...
                className="px-4 py-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm text-primary-600 rounded-full flex items-center gap-2 hover:bg-primary-600 hover:text-white transition-colors duration-300 font-medium text-sm shadow-lg"
              >
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-3">
          <motion.button
            ...
            className={`p-2 backdrop-blur-sm rounded-full shadow-lg 
              ${isBookmarked 
                ...
                : 'bg-white/80 dark:bg-gray-800/80 text-gray-700 dark:text-gray-300 hover:bg-primary-50 dark:hover:bg-primary-900/30'
          ...
          <motion.button
            whileTap={pulseAnimation}
            onClick={handleShare}
            className="p-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-700 dark:text-gray-300 rounded-full hover:bg-primary-50 dark:hover:bg-primary-900/30 transition-colors duration-200 shadow-lg"
          >
            <img 
              src={shareIcon} 
              alt="Share" 
...
const Blog = () => {
  ...
  const categories = ['All', 'Buying', 'Selling', 'Investment', 'Tips', 'Market Updates'];
    ...
    const fetchBlogPosts = async () => {
      try {
        ...
        if (response.data.success && response.data.data.length > 0) {
          ...
          // If no posts or error, use fallback data
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            ...
            <span className="ml-3 text-lg text-gray-600 dark:text-gray-300">Loading blog posts...</span>
          </div>
        ) : error ? (
          <div className="text-center py-16 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
            <div className="text-red-500 dark:text-red-400 text-xl mb-2">{error}</div>
          ...
          >
            ...
            <h3 className="text-xl font-medium text-gray-600 dark:text-gray-300 mb-2">No articles found</h3>
