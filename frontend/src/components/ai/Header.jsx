...
import { Brain, ArrowLeft, Menu, X } from '../utils/icons.jsx';
...
const Header = ({ title = "AI Property Assistant" }) => {
  ...
  return (
    <motion.header
      ...
      className="bg-gradient-to-r from-primary-500 to-primary-700 text-white py-4 px-4 sm:px-6 shadow-lg relative z-50"
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        <Link to="/ai-property-hub" className="flex items-center gap-2">
          ...
          >
            <h1 className="text-xl sm:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-primary-100">
              {title}
            </h1>
          </motion.div>
        </Link>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="sm:hidden bg-primary-600 shadow-lg overflow-hidden"
          >
