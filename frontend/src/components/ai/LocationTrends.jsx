...
import { MapPin, TrendingUp, ArrowUp, DollarSign, BarChart3, Info, AlertCircle } from '../utils/icons.jsx';
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <span className="font-medium">
                        {location.price_per_sqft ? `KSh ${location.price_per_sqft.toLocaleString()}` : 'N/A'}
                      </span>
                    </div>
                    <div>
              ...
              <table className="min-w-full bg-white">
                <thead>
                  <tr className="bg-gray-50 border-b">
                    ...
                    <th className="py-3 px-4 text-left font-medium text-gray-700">Price per sq.ft (KSh)</th>
