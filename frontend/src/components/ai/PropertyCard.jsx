...
import { Building, MapPin, Maximize, Tag, Plus, ArrowRight } from '../utils/icons.jsx';
...
const PropertyCard = ({ property }) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-primary-500 to-primary-700 p-4 sm:p-5 relative">
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center text-primary-100 flex-wrap">
        ...
        <div className="mb-4 sm:mb-5 flex-1">
          ...
          >
            <h4 className="text-sm font-medium text-gray-700 flex items-center">
              <Building className="w-4 h-4 text-primary-500 mr-1.5" />
              Overview
            </h4>
            <motion.div 
        ...
        {property.amenities && property.amenities.length > 0 && (
          <div className="mt-auto">
            <h4 className="text-sm font-medium text-gray-700 mb-2 flex items-center">
              <Tag className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-500 mr-1.5" />
              Amenities
            </h4>
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {property.amenities.slice(0, isExpanded ? property.amenities.length : 2).map((amenity, index) => (
                <motion.span 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-primary-50 text-primary-700 text-xs px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full border border-primary-100"
                >
                  {amenity}
                </motion.span>
              ))}
