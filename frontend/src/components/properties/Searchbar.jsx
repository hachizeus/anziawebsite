...
import { X, MapPin } from '../utils/icons.jsx';
import { motion, AnimatePresence } from 'framer-motion';

// Import your custom search icon (replace with your actual image filename)
import searchIcon from '../../../public/images/32px-VK_icons_search_outline_56.png'; // Example - adjust to your preferred icon
    ...
    <div className={`relative ${className}`}>
      <form onSubmit={handleSubmit} className="relative">
        ...
        <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
          ...
          <button 
            type="submit"
            className="bg-blue-600 text-white px-2 sm:px-4 py-1.5 rounded-lg 
              hover:bg-blue-700 transition-colors flex items-center gap-1 sm:gap-2 text-sm sm:text-base"
          >
            {/* Custom search icon for the button */}
            <img 
              src={searchIcon} 
              alt="Search"
              className="h-4 w-4 invert brightness-0" // Makes icon white
            />
